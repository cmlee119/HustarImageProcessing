// OpenCV Marker Test.cpp : 이 파일에는 'main' 함수가 포함됩니다. 거기서 프로그램 실행이 시작되고 종료됩니다.
//
...
void init()
{
    inputVideo.open("C:/Users/cmlee/source/repos/OpenCv Test/test.mp4");
}
...
void loop()
{
    ...
    imshow("Output_image", input_image);
